...
:x86
@echo ***********************************************************************
@echo *          The program will automatically inject 32-bit Helium         *
...
echo+
@echo ***********************************************************************
@echo *          The program will automatically inject 64-bit Helium         *
@echo *                     Press any key to continue                       *
@echo ***********************************************************************
echo+
@pause .
...
echo+
@echo ***********************************************************************
@echo *          The program will automatically inject ARM64 Helium          *
@echo *                     Press any key to continue                       *
@echo ***********************************************************************
echo+
@pause .
